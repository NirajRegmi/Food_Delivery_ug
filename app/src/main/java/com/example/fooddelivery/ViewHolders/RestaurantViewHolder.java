...
import com.example.fooddelivery.UI.TabApp;
    ...
    public void setData (Restaurateur current, int position, String key){
        ...
        if(favorite_visible) {
            ...
            favorite.setOnClickListener(e -> {
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference(fooddelivery_PATH).child(ROOT_UID).child(fooddelivery_FAVOURITE_RESTAURANT_PATH);
                if (favorite_bool) {
