 ...
 * {@link com.example.fooddelivery} interface
 * to handle interaction events.
 * Use the {@link com.example.fooddelivery.UI.Profile#newInstance} factory method to
...
public class Profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference myRef = database.getReference(fooddelivery_PATH).child(ROOT_UID);
        setHasOptionsMenu(true);
        Log.d("PATH",fooddelivery_PATH+"/"+ROOT_UID);
