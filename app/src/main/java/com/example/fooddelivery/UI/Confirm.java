...
import com.example.fooddelivery.Adapters.ConfirmRecyclerAdapter;
...
import static com.example.mylibrary.SharedClass.TimeOpen;
...
public class Confirm extends AppCompatActivity {
    ...
    private RecyclerView.Adapter exampleapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.confirm_order_button).setOnClickListener(e->{
            if(desiredTime.trim().length() > 0){
                ...
                DatabaseReference myRef2 = FirebaseDatabase.getInstance().getReference(fooddelivery_PATH + "/" + ROOT_UID).child("orders");
    ...
    private void getIncomingIntent (){
        ...
        exampleapter = new ConfirmRecyclerAdapter(this, names, prices, nums, com.example.fooddelivery.UI.Confirm.this);
    ...
    private void setDesiredTimeDialog(){
        ...
        LayoutInflater inflater = LayoutInflater.from(com.example.fooddelivery.UI.Confirm.this);
