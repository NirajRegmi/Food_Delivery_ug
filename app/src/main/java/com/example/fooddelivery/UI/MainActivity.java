                ...
                auth.signInWithEmailAndPassword(email, password)
                        .addOnCompleteListener(this, task -> {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(com.example.fooddelivery.UI.MainActivity.this,"Wrong Username or Password", Toast.LENGTH_LONG).show();
                            }
                        });
            }
            else{
                Toast.makeText(com.example.fooddelivery.UI.MainActivity.this, errMsg, Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
