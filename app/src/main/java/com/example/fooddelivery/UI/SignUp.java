...
import static com.example.fooddelivery.R.color.colorPrimary;
...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyAecO_g2fLnkd4wC12oYbuKYrJxXN2JsBA"); //Google map api key
    ...
    private void storeDatabase() {
        ...
        DatabaseReference myRef = database.getReference(fooddelivery_PATH + "/" + ROOT_UID);
        ...
        if(currentPhotoPath != null) {
            ...
            ref.putFile(url).continueWithTask(task -> {
                ...
                if (task.isSuccessful()){
                    ...
                    new_user.put("customer_info",new User( name, surname
