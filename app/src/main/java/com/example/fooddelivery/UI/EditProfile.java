...
import static com.example.mylibrary.SharedClass.*;
import static com.example.mylibrary.SharedClass.Address;
import static com.example.mylibrary.SharedClass.fooddelivery_PATH;
import static com.example.mylibrary.SharedClass.CameraOpen;
import static com.example.mylibrary.SharedClass.Mail;
import static com.example.mylibrary.SharedClass.Name;
import static com.example.mylibrary.SharedClass.PERMISSION_GALLERY_REQUEST;
import static com.example.mylibrary.SharedClass.Phone;
import static com.example.mylibrary.SharedClass.Photo;
import static com.example.mylibrary.SharedClass.ROOT_UID;
import static com.example.mylibrary.SharedClass.user;
...
public class EditProfile extends AppCompatActivity {
    ...
    private void storeDatabase(){
        ...
        DatabaseReference myRef = FirebaseDatabase.getInstance().getReference(fooddelivery_PATH + "/" + ROOT_UID);
        ...
        if(photoChanged && currentPhotoPath != null) {
            ...
            ref.putFile(photoUri).continueWithTask(task -> {
                ...
                if (task.isSuccessful()){
                    ...
                    profileMap.put("customer_info", new User( name, surname
    ...
    private void editPhoto(){
        AlertDialog alertDialog = new AlertDialog.Builder(com.example.fooddelivery.UI.EditProfile.this, R.style.AppTheme_AlertDialogStyle).create();
        LayoutInflater factory = LayoutInflater.from(com.example.fooddelivery.UI.EditProfile.this);
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.fooddelivery.fileprovider",
                        photoFile);
