...
public class OrderDetailsRecyclerAdapter extends RecyclerView.Adapter<com.example.fooddelivery.Adapters.OrderDetailsRecyclerAdapter.MyViewHolder> {
    ...
    @Override
    public com.example.fooddelivery.Adapters.OrderDetailsRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view =  mInflater.inflate(R.layout.detailorder_dishitem, parent, false);
        return new com.example.fooddelivery.Adapters.OrderDetailsRecyclerAdapter.MyViewHolder(view);
    }
