...
import com.example.fooddelivery.UI.Confirm;
import com.example.fooddelivery.R;


import java.util.ArrayList;

public class ConfirmRecyclerAdapter extends RecyclerView.Adapter<com.example.fooddelivery.Adapters.ConfirmRecyclerAdapter.MyViewHolder>  {
    ...
    @NonNull
    @Override
    public com.example.fooddelivery.Adapters.ConfirmRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =  mInflater.inflate(R.layout.dish_confirm_item, viewGroup, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.fooddelivery.Adapters.ConfirmRecyclerAdapter.MyViewHolder myViewHolder, int position) {
