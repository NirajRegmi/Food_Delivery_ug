...
public final class SharedClass {
    ...
    public static final String fooddelivery_ID = "fooddelivery_ID";
    ...
    public static final String fooddelivery_PATH = "/customer_info";
    public static final String fooddelivery_FAVOURITE_RESTAURANT_PATH = "/favourites";

    /**
     * List of orders for a fooddelivery
     */
