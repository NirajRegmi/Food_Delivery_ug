            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    for(DataSnapshot d : dataSnapshot.getChildren()){
                        final com.example.mylibrary.DishItem dishItem = d.getValue(com.example.mylibrary.DishItem.class);
                        ...
                        if(dishes.containsKey(dishItem.getName())){
                            ...
                            updateDish.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.exists()){
                                        com.example.mylibrary.DishItem newDishItem = dataSnapshot.getValue(com.example.mylibrary.DishItem.class);
